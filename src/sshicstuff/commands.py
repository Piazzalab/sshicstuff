...
class Associate(AbstractCommand):
    ...
    Arguments:
        ...
        -c OLIGO_CAPTURE, --oligo-capture OLIGO_CAPTURE         Path to the oligo capture file

    Options:

        -o output, --output OUTPUT                              Path to the oligo capture file. If not specified,
                                                                it will use the parent directory of the capture oligo file.
    """
...
class Profile(AbstractCommand):
    ...
    usage:
        profile -c OLIGO_CAPTURE -C CHR_COORD -f FILTERED_TAB  [-o OUTPUT] [-a ADDITIONAL] [-F] [-N] [--p2p-matrix]

...
samples_dir="/home/nicolas/Documents/Projects/ssHiC/bash_scripts/aggregate_contacts/inputs/10kb"
...
parallel --jobs 6 '
    ...
    contacts="/home/nicolas/Documents/Projects/ssHiC/bash_scripts/aggregate_contacts/inputs/10kb/${filename}"
    ...
    for score in ${scores_list[@]}; do
	    ...
	    contacts="/home/nicolas/Documents/Projects/ssHiC/bash_scripts/aggregate_contacts/inputs/1kb/${filename}"

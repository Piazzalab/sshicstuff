...
def aggregate(
    ...
    df_aggregated_mean.to_csv(
        join(dir_tables, f"aggregated_mean_contacts_around_{on}_{norm_suffix}.tsv"), sep="\t")
    ...
    df_aggregated_std.to_csv(
        join(dir_tables, f"aggregated_std_contacts_around_{on}_{norm_suffix}.tsv"), sep="\t")
    ...
    df_aggregated_median.to_csv(
        join(dir_tables, f"aggregated_median_contacts_around_{on}_{norm_suffix}.tsv"), sep="\t")
